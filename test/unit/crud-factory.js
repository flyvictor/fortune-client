const crudFactory = require('../../lib/factories/crud-factory'),
  ...
  describe('crud', function () {
    describe('with fortune', function () {
      ...
      it('replaces a document', function (done) {
        crud.fancy
          .replaceResource(0, { data: 1 }, { opts: 1 })()
          .then(function () {
      ...
      it('updates a document', function (done) {
        crud.fancy
          .updateResource(0, { data: 1 }, { opts: 1 })()
          .then(function () {
      ...
      it('passes auth credentials', function (done) {
        crud.fancy
          .getResource(1, { access: { policy: ['default'] } })()
          .then(function () {
            fortune.direct.get.calledWith('resources', {
              params: { id: 1 },
              query: {},
      ...
      describe('for single-form resources', function () {
        ...
        it('gets a collection of documents', function (done) {
          crud.fancy
            .getSingularOnly(null, { opts: true })()
            .then(function () {
              fortune.direct.get.calledWith('singular-only', {
                opts: true,
                query: {},
        ...
        it('creates a document', function (done) {
          crud.fancy
            .createSingularOnly({ data: 1 }, { opts: 1 })()
            .then(function () {
        ...
        it('replaces a document', function (done) {
          crud.fancy
            .replaceSingularOnly(0, { data: 1 }, { opts: 1 })()
            .then(function () {
        ...
        it('updates a document', function (done) {
          crud.fancy
            .updateSingularOnly(0, { data: 1 }, { opts: 1 })()
            .then(function () {
        ...
        it('merges collection query into the request query filters', function () {
          ...
          crud.fancy.destroySingularOnly(
            { foo: 1 },
            { filter: { bar: 1 } },
          )(function (config) {
            config.request.query.filter.should.be.eql({ foo: 1 });
      ...
      describe('parent request', function () {
        it('is passed through to the crud callback', function (done) {
          const parent = { parentRequest: 'is me' };

          crud.fancy.getResource(0, { parentRequest: parent })(function (
            config,
          ) {
      ...
      it('rejects a promise if error returned', function (done) {
        fortune.direct.get.returns(
          Promise.resolve({
            error: 'Something wrong happened',
            detail: 'MongoError: database not found',
          }),
        );
        crud.fancy
          .getResource(0, { opts: true })()
      ...
      it('rejects a promise with main error if detail is absent', function (done) {
        fortune.direct.get.returns(
          Promise.resolve({ error: 'Something wrong happened' }),
        );
        crud.fancy
          .getResource(0, { opts: true })()
          .then(function () {
