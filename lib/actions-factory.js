...
module.exports  = function(app, resources){
    ...
    function makeAction(resource, actionName, action){
        ...
        return function(resourceId, data, options){
            if([null, void 0, ""].indexOf(resourceId) !== -1) throw new Error("[action-factory] - makeAction: Id cannot be empty, null or undefined!");
            
            var methodName = action.method ? action.method.toUpperCase() : "POST";
            var request = util.toDirectRequest(resourceId,options,data.params,data.body);
            ...
            return wrapCall(methodName, resource.route, options);
        };
    }
