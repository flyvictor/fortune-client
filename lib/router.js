var crudFactory = require("./crud-factory"),
    actionsFactory = require("./actions-factory"),
    when = require("when"),
    _ = require("lodash");
...
module.exports = function(){
  ...
  var self = {
    ...
    registerActions: function(app,resources){
      var actions = actionsFactory(app, resources);
      _.each(actions.list, function(action, name){
        self.actions[name] = function(){
          return action.apply(actions.list,arguments)(actionPipeline);
        };
      });
    },
