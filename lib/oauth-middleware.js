...
exports.Middleware = function(oauth){
  oauth = oauth || {};
  ...
  return function(requestParams){
    ...
    signatureData.appToken = oauth.key;
    signatureData.appSecret = oauth.secret;

    requestParams.header.Authorization = "OAuth " + _.map({
        ...
        oauth_version: "1.0",
        oauth_signature: encode(buildSignature(requestParams, signatureData))
      },function(v,k){
        return k + "=" + v;
      }).join(",");
