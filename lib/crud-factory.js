...
module.exports = function(app, resources){
  ...
  function toDirectRequest(query, options, resourceName, data){
    request = _.extend({query: {}, params: {}}, options);
  ...
  function makeAction(name, resource){
    return {
      get: function(query,options){
        return wrapDirectCall(name, resource.route, toDirectRequest(query,options));
      },
      ...
      update: function(id, data, options){
        ...
        return wrapDirectCall(name, resource.route, toDirectRequest(id,options,null,data));
      }
    }[name];
  }
